...
export default function Home() {
  ...
  return (
    <div>
        ...
        <h1 className='text-center md:text-left font-semibold text-3xl p-4'>Discover</h1>
        <Music_Card_List />
        <h1 className=' text-center md:text-left font-semibold text-3xl p-4'>Top Picks</h1>
