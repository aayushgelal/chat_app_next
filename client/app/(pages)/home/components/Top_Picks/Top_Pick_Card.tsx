...
const ProgressBar = ({Progress_ref,audio_ref,duration}: any) => {
  ...
  return (
    <div >
      ...
      <input type="range" className='input' ref={Progress_ref}   defaultValue="0"
  ...
  return (
    <div className='shadow-lg  mw-96  px-3 m-4 rounded-lg'>
        ...
        <button onClick={handleClick} >
            {isplaying? <AiFillPauseCircle className='' size={40} color='gray'/>:<AiFillPlayCircle className='' size={40} color='gray'/>}
            </button>
            <audio
